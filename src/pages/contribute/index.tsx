    ...
    const loadData = async () => {
      ...
      try {
        ...
        const airResponse = await fetch(
          '/data/airnow/airnow_94720_400days.json'
        );
        if (!airResponse.ok)
  ...
  useEffect(() => {
    if (
      ...
      const latestAirData = airQualityData
        .sort(
          (a, b) =>
            new Date(b.DateObserved).getTime() -
            new Date(a.DateObserved).getTime()
        )
        .slice(0, 10);
      ...
      latestAirData.forEach((reading, index) => {
        ...
        const lng = -122.268 + (Math.random() * 0.01 - 0.005);
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary">
            Help monitor and track Berkeley's environment by submitting tree
            measurements or air quality readings you collect during fieldwork.
          </Typography>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Use exact GPS measurements and report the average for more
                    reliable data.
                  </Typography>
                </Box>
              </Box>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Use your device's GPS or select a point on the map for
                    precise location.
                  </Typography>
                </Box>
              </Box>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    All data is peer-reviewed by experts for enhanced data
                    transparency.
                  </Typography>
                </Box>
              </Box>
            ...
            >
                  ...
                  <FormControl fullWidth error={!!errors.species} size="small">
                    <Select
                      ...
                      renderValue={(selected) =>
                        selected ? selected : 'Select a tree species'
                      }
                    >
                      {loading ? (
                        <MenuItem disabled>
                        ...
                        <>
                          {treeSpeciesList.map((speciesName) => (
                            <MenuItem key={speciesName} value={speciesName}>
                              {speciesName}
                            </MenuItem>
                          ))}
                    ...
                    <FormHelperText>
                      {errors.species ||
                        "Select from Berkeley's tree inventory"}
                    </FormHelperText>
                  </FormControl>
                </Box>
              )}
              ...
              {dataType === 'air' && (
                <Box sx={{ mb: 3 }}>
                  ...
                  <TextField
                    ...
                    error={!!errors.pm25}
                    helperText={
                      errors.pm25 || 'Fine particulate matter reading'
                    }
                    size="small"
                    type="number"
                    inputProps={{ min: 0 }}
              ...
              {dataType === 'air' && (
                <Box sx={{ mb: 3 }}>
                  ...
                  <TextField
                    ...
                    error={!!errors.pm10}
                    helperText={
                      errors.pm10 || 'Coarse particulate matter reading'
                    }
                    size="small"
                    type="number"
                    inputProps={{ min: 0 }}
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <TextField
                  ...
                  placeholder={
                    dataType === 'air'
                      ? 'Weather conditions, nearby activities...'
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" paragraph>
                  Use the "stick method" - hold a stick at arm's length, align
                  the top with the tree top and bottom with the base. The
                  distance from you to the tree equals the tree height.
                </Typography>
                ...
                <Typography variant="body2" paragraph>
                  Measure the diameter at breast height (DBH) at 4.5 feet
                  (1.37m) above ground using a measuring tape around the trunk.
                  Divide by π (3.14) to get diameter.
                </Typography>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" paragraph>
                  Take readings at different times of day for more comprehensive
                  data. Morning, midday, and late afternoon readings are
                ...
                <Typography variant="body2" paragraph>
                  Place sensors at breathing height (about 5 feet) away from
                  direct pollution sources and clear of obstructions.
                </Typography>
                ...
                <Typography variant="body2">
                  For consumer-grade sensors, take multiple readings over 5-10
                  minutes and report the average for more reliable data.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
