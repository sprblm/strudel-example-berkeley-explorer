...
const DatasetExplorerContent: React.FC = () => {
  ...
  const [selectedTreePoint, setSelectedTreePoint] =
  ...
  useEffect(() => {
    ...
    if (activeFilters.length > 0) {
      ...
      // If no filters, show only trees by default
      setActiveLayers(['trees']);
    }
  ...
  const handleMapPointClick = (point: any) => {
    ...
    const relatedDataset = datasets.find(
      (dataset) => dataset.details?.type === point.type
    );
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="body1" color="text.secondary">
                  Find and explore datasets from the local various sources and
                  repositories.
                </Typography>
              </Box>
            </Box>
              ...
              >
                ...
                {loading ? (
                  ...
                  <DataListPanel
                    ...
                    setPreviewItem={(item: Dataset | null) =>
                      setPreviewItem(item)
                    }
                  ...
                  <Typography color="text.secondary">
                    No datasets found matching your criteria. Try adjusting your
                    search.
                  </Typography>
                )}
              </Paper>
