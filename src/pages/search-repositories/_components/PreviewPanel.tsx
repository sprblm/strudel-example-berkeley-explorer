...
export const PreviewPanel: React.FC<PreviewPanelProps> = ({
  ...
  const getDatasetProperty = <T extends unknown>(
    item: any,
    key: string,
      ...
      <Stack spacing={3}>
        ...
        <Stack spacing={1}>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            {getDatasetProperty<string>(previewItem, fieldMapping.source) && (
              <Chip
                label={getDatasetProperty<string>(
                  previewItem,
                  fieldMapping.source
                )}
                color="primary"
            ...
            {getDatasetProperty<string>(previewItem, fieldMapping.quality) && (
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Rating
                  value={parseInt(
                    getDatasetProperty<string>(
                      previewItem,
                      fieldMapping.quality,
                      '0'
                    )
                  )}
                  readOnly
        ...
        {getDatasetProperty<string>(previewItem, fieldMapping.thumbnail) && (
          ...
          >
            <Box
              component="img"
              src={getDatasetProperty<string>(
                previewItem,
                fieldMapping.thumbnail
              )}
        ...
        <Box>
          ...
          <Grid container spacing={2}>
            ...
            {getDatasetProperty<string>(
              previewItem,
              fieldMapping.temporal_coverage
            ) && (
        ...
        <Stack direction="row" spacing={2} justifyContent="space-between">
          ...
          <Stack direction="row" spacing={2}>
            ...
            {getDatasetProperty<string>(
              previewItem,
              fieldMapping.download_url
            ) && (
              <Button
                variant="contained"
                color="primary"
                startIcon={<DownloadIcon />}
                href={getDatasetProperty<string>(
                  previewItem,
                  fieldMapping.download_url
                )}
                target="_blank"
