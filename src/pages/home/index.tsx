  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const latestPM25 =
          sortedData.find((d) => d.ParameterName === 'PM2.5') || null;
        const latestOzone =
          sortedData.find((d) => d.ParameterName === 'OZONE') || null;
            ...
            <Grid item xs={12} md={6}>
              <Paper
                ...
                sx={{
                  ...
                  borderLeftColor: latestAirQuality.pm25
                    ? getAqiColor(latestAirQuality.pm25.AQI)
                    : '#ccc',
                }}
              >
                            ...
                            {latestAirQuality.ozone && (
                              <Chip
                                ...
                                sx={{
                                  ml: 1,
                                  bgcolor: getAqiColor(
                                    latestAirQuality.ozone.AQI
                                  ),
                                  color:
                                    latestAirQuality.ozone.AQI <= 100
                                      ? '#000'
                                      : '#fff',
                                }}
                              />
