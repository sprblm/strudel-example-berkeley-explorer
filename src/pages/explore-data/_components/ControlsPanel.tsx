...
interface ControlsPanelProps {
  ...
  setActiveChart: React.Dispatch<
    React.SetStateAction<'map' | 'timeSeries' | 'histogram' | 'distribution'>
  >;
  dataType: string;
    ...
    <>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ pl: 1 }}>
          ...
          <Typography variant="body1">9.6 μg/m³</Typography>
        </Box>
      </Box>
    ...
    <>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ height: 200, position: 'relative' }}>
          ...
          <Typography
            variant="caption"
            sx={{ position: 'absolute', left: 0, top: 115 }}
          >
            0.5
          </Typography>
          ...
          [
            ...
            >
              ...
              <Box sx={{ pl: 1 }}>
                ...
                <Typography fontSize={14} sx={{ mb: 0.5 }}>
                  Ozone: <b>{item.Ozone}</b>
                </Typography>
                <Typography fontSize={14} sx={{ mb: 0.5 }}>
                  Temperature: <b>{item.Temp}</b>
                </Typography>
                <Typography fontSize={14}>
                  Humidity: <b>{item.Humidity}</b>
                </Typography>
              </Box>
            </Paper>
          ))
