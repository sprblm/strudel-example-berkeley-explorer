...
const LOCATION_COORDINATES: Record<string, [number, number]> = {
  'Memorial Glade': [37.8728, -122.26],
  'Hearst Greek Theatre': [37.8743, -122.2548],
  'Sather Gate': [37.8702, -122.259],
  Campanile: [37.8721, -122.2578],
  'Botanical Garden': [37.8756, -122.239],
...
const LocationMap: React.FC<LocationMapProps> = ({
  ...
  useEffect(() => {
    if (mapContainerRef.current && !mapRef.current) {
      ...
      const coordinates = LOCATION_COORDINATES[location] || [37.8728, -122.26];
