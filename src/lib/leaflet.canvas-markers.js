    ...
    e.prototype = {
      ...
      _build: function (t, n, i, a) {
        ...
        for (p(t, n, i, f, this.compareMinX), h = n; h <= i; h += f)
          for (
            p(t, h, (c = Math.min(h + f - 1, i)), u, this.compareMinY), l = h;
            l <= c;
            l += u
          )
            (m = Math.min(l + u - 1, c)),
      ...
      _chooseSplitIndex: function (t, n, i) {
        ...
        for (l = c = 1 / 0, a = n; a <= i - n; a++)
          (e = s(t, 0, a, this.toBBox)),
            ...
            (o = Math.max(0, g - _) * Math.max(0, x - p)),
            (h = m(e) + m(r)),
            o < l
              ? ((l = o), (u = a), (c = h < c ? h : c))
              : o === l && h < c && ((c = h), (u = a));
    ...
    t.exports = function (t) {
      var n = (t.Layer ? t.Layer : t.Class).extend({
        ...
        _initCanvas: function () {
          ...
          (this._canvas.width = n.x),
            (this._canvas.height = n.y),
            (this._context = this._canvas.getContext('2d'));
          var i = this._map.options.zoomAnimation && t.Browser.any3d;
          t.DomUtil.addClass(
            this._canvas,
            'leaflet-zoom-' + (i ? 'animated' : 'hide')
          );
        },
